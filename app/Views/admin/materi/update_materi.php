    ...
    <div class="col-sm-12">
        ...
        <div class="card shadow mb-4 card-data">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Update Materi</h6>
            </div>
                ...
                <form action="/materi/update/<?= $materi['id']; ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <select class="rounded-right custom-select <?= ($validation->hasError('id_modul')) ? ' is-invalid' : ''; ?>" id="inputGroupSelect01" name="id_modul">
                            <option value="<?= (old('id_modul')) ? old('id_modul') : $materi['id_modul']; ?>" selected hidden><?= (old('id_modul')) ? old('id_modul') : $materi['id_modul'] . '. ' . $id_modul['judul_modul']; ?></option>
                            <?php
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="rounded-right form-control<?= ($validation->hasError('judul_materi')) ? ' is-invalid' : ''; ?>" placeholder="" aria-label="Username" aria-describedby="basic-addon1" name="judul_materi" value="<?= (old('judul_materi')) ? old('judul_materi') : $materi['judul_materi']; ?>">
                        <div class="invalid-feedback">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-deskripsi form-control text rounded<?= ($validation->getError('konten_materi')) ? ' is-invalid' : ''; ?>" id="exampleFormControlTextarea" name="konten_materi" rows="4"><?= (old('konten_materi')) ? old('konten_materi') : $materi['konten_materi']; ?></textarea>
                        <div class="invalid-feedback">
