                ...
                <form action="/kategori/save" method="post" enctype="multipart/form-data">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <select class="rounded-right custom-select <?= ($validation->hasError('id_kesulitan')) ? ' is-invalid' : ''; ?>" id="inputGroupSelect01" name="id_kesulitan">
                            <option value="<?= (old('id_kesulitan')) ? old('id_kesulitan') : ''; ?>" selected hidden><?= (old('id_kesulitan')) ? old('id_kesulitan') : 'Choose...'; ?></option>
                            <?php
                            foreach ($kesulitan as $kesulitan) :
                            ?>
                                <option value="<?= $kesulitan['id']; ?>"><?= $kesulitan['id'] . '. ' . $kesulitan['kesulitan']; ?></option>
                            <?php
                            endforeach;
                            ?>
                        </select>
                    ...
                    <div class="col-sm-2 mt-2">
                        <img src="/img/kategori/picture.png" alt="" class="img-thumbnail img-preview">
                    </div>
