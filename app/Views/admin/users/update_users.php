            ...
            <div class="card-body add-blog px-4 tambah-user">
                <form action="/user/update/<?= $user['id']; ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="rounded-right form-control<?= ($validation->hasError('nama_depan')) ? ' is-invalid' : ''; ?>" placeholder="" aria-label="Username" aria-describedby="basic-addon1" name="nama_depan" value="<?= (old('nama_depan')) ? old('nama_depan') : $user['nama_depan']; ?>">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="rounded-right form-control<?= ($validation->hasError('nama_belakang')) ? ' is-invalid' : ''; ?>" placeholder="" aria-label="Username" aria-describedby="basic-addon1" name="nama_belakang" value="<?= (old('nama_belakang')) ? old('nama_belakang') : $user['nama_belakang']; ?>">
                        <div class="invalid-feedback">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="rounded-right form-control<?= ($validation->hasError('email')) ? ' is-invalid' : ''; ?>" placeholder="" aria-label="Username" aria-describedby="basic-addon1" name="email" value="<?= (old('email')) ? old('email') : $user['email']; ?>">
                        <div class="invalid-feedback">
                    ...
                    <div class="input-group">
                        ...
                        <input type="password" class="rounded-right form-control<?= ($validation->hasError('password')) ? ' is-invalid' : ''; ?>" placeholder="" id="user-password" aria-label="Username" aria-describedby="basic-addon1" name="password" value="<?= (old('password')) ? old('password') : $user['password']; ?>">
                        <div class="invalid-feedback">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="rounded-right form-control<?= ($validation->hasError('username')) ? ' is-invalid' : ''; ?>" placeholder="" aria-label="Username" aria-describedby="basic-addon1" name="username" value="<?= (old('username')) ? old('username') : $user['username']; ?>">
                        <div class="invalid-feedback">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <duet-date-picker name="tanggal_lahir" identifier="date" class="datepicker border rounded-right<?= ($validation->hasError('tanggal_lahir')) ? ' is-invalid' : ''; ?>" min="1980-01-01" value="<?= (old('tanggal_lahir')) ? old('tanggal_lahir') : $user['tanggal_lahir']; ?>"></duet-date-picker>
                        <div class="invalid-feedback">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <select class="rounded-right custom-select<?= ($validation->hasError('jenis_kelamin')) ? ' is-invalid' : ''; ?>" id="inputGroupSelect01" name="jenis_kelamin">
                            <option value="<?= (old('jenis_kelamin')) ? old('jenis_kelamin') : $user['jenis_kelamin']; ?>" selected hidden><?= (old('jenis_kelamin')) ? old('jenis_kelamin') : $user['jenis_kelamin']; ?></option>
                    ...
                    <div class="input-group mb-1">
                        ...
                        <div class="custom-file">
                            <input type="file" class="rounded-right custom-file-input<?= ($validation->hasError('foto')) ? ' is-invalid' : ''; ?>" id="foto" aria-describedby="inputGroupFileAddon01" name="foto" onchange="previewImage()" value="<?= (old('foto')) ? old('foto') : $user['foto']; ?>">
                            <div class="invalid-feedback invalid-foto">
                                <?= $validation->getError('foto'); ?>
                            </div>
                            <label class="custom-file-label" id="label-gambar" for="inputGroupFile01"><?= $user['foto']; ?></label>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-2 mt-3">
                        <img src="/img/user/<?= $user['foto'] ?>" alt="" class="img-thumbnail img-preview">
                    </div>
