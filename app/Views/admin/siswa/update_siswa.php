    ...
    <div class="col-sm-12">
        ...
        <div class="card shadow mb-4 card-data">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Update Siswa</h6>
            </div>
                ...
                <form action="/siswa/update/<?= $siswa['id']; ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <select class="rounded-right custom-select <?= ($validation->hasError('id_user')) ? ' is-invalid' : ''; ?>" id="inputGroupSelect01" name="id_user">
                            <option value="<?= (old('id_user')) ? old('id_user') : $siswa['id_user']; ?>" selected hidden><?= (old('id_user')) ? old('id_user') : $siswa['id_user'] . '. ' . $dt_user['nama_depan'] . ' ' . $dt_user['nama_belakang']; ?></option>
                            <?php
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="rounded-right form-control<?= ($validation->hasError('nama_sekolah')) ? ' is-invalid' : ''; ?>" placeholder="" aria-label="Username" aria-describedby="basic-addon1" name="nama_sekolah" value="<?= (old('nama_sekolah')) ? old('nama_sekolah') : $siswa['nama_sekolah']; ?>">
                        <div class="invalid-feedback">
