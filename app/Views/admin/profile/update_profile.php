    ...
    <div class="col-sm-12">
        ...
        <div class="card shadow mb-4 card-data">
            ...
            <div class="card-body add-blog px-4 tambah-admin">
                <form action="/admin/updateProfile/<?= $admin['id']; ?>" method="post" enctype="multipart/form-data">
                    <?= csrf_field(); ?>
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="password" class="rounded-right form-control<?= ($validation->hasError('password')) ? ' is-invalid' : ''; ?>" placeholder="" aria-label="Username" aria-describedby="basic-addon1" name="password" value="<?= (old('password')) ? old('password') : $admin['password']; ?>">
                        <div class="invalid-feedback">
                    ...
                    <a href="/" class="btn btn-danger back btn-back">Back</a>
                </form>
            </div>
        </div>
    </div>
