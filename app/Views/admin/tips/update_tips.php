    ...
    <div class="col-sm-12">
        ...
        <div class="card shadow mb-4 card-data">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Update Tips</h6>
            </div>
            <div class="card-body add-blog px-4 tambah-kesulitan">
                <form action="/tips/update/<?= $tips['id']; ?>" method="post" enctype="multipart/form-data">
                    <?= csrf_field(); ?>
                    ...
                    <div class="input-group mb-3">
                        ...
                        <select class="rounded-right custom-select <?= ($validation->hasError('id_kategori')) ? ' is-invalid' : ''; ?>" id="inputGroupSelect01" name="id_kategori">
                            <option value="<?= (old('id_kategori')) ? old('id_kategori') : $tips['id_kategori']; ?>" selected hidden><?= (old('id_kategori')) ? old('id_kategori') : $tips['id_kategori'] . '. ' . $id_kategori['nama_kategori']; ?></option>
                            <?php
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="rounded-right form-control<?= ($validation->hasError('judul_tips')) ? ' is-invalid' : ''; ?>" placeholder="" aria-label="Username" aria-describedby="basic-addon1" name="judul_tips" value="<?= (old('judul_tips')) ? old('judul_tips') : $tips['judul_tips']; ?>">
                        <div class="invalid-feedback">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-deskripsi form-control text rounded<?= ($validation->getError('konten_tips')) ? ' is-invalid' : ''; ?>" id="exampleFormControlTextarea" name="konten_tips" rows="4"><?= (old('konten_tips')) ? old('konten_tips') : $tips['konten_tips']; ?></textarea>
                        <div class="invalid-feedback">
