    ...
    <div class="col-sm-12">
        ...
        <div class="card shadow mb-4 card-data">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Update Gambar Materi</h6>
            </div>
            <div class="card-body add-blog px-4 tambah-kesulitan">
                <form action="/gambarmateri/update/<?= $gambar_materi['id']; ?>" method="post" enctype="multipart/form-data">
                    <?= csrf_field(); ?>
                    ...
                    <div class="input-group mb-3">
                        ...
                        <select class="rounded-right custom-select <?= ($validation->hasError('id_materi')) ? ' is-invalid' : ''; ?>" id="inputGroupSelect01" name="id_materi">
                            <option value="<?= (old('id_materi')) ? old('id_materi') : $gambar_materi['id_materi']; ?>" selected hidden><?= (old('id_materi')) ? old('id_materi') : $gambar_materi['id_materi'] . '. ' . $id_materi['judul_materi'];
                                                                                                                                        ?></option>
                            <?php
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="rounded-right form-control<?= ($validation->hasError('alt_text')) ? ' is-invalid' : ''; ?>" placeholder="" aria-label="Username" aria-describedby="basic-addon1" name="alt_text" value="<?= (old('alt_text')) ? old('alt_text') : $gambar_materi['alt_text']; ?>">
                        <div class="invalid-feedback">
                    ...
                    <div class="input-group mb-1">
                        ...
                        <div class="custom-file">
                            <input type="file" class="rounded-right custom-file-input<?= ($validation->hasError('foto')) ? ' is-invalid' : ''; ?>" id="foto" aria-describedby="inputGroupFileAddon01" name="foto" onchange="previewFoto()" value="<?= (old('foto')) ? old('foto') : $gambar_materi['foto']; ?>">
                            <label class="custom-file-label" id="label-gambar" for="inputGroupFile01"><?= (old('foto')) ? old('foto') : $gambar_materi['foto']; ?></label>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-2 mt-3">
                        <img src="/img/user/<?= (old('foto')) ? old('foto') : $gambar_materi['foto']; ?>" alt="" class="img-thumbnail img-preview">
                    </div>
