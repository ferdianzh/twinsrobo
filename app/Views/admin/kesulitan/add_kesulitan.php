    ...
    <div class="col-sm-12">
        ...
        <div class="card shadow mb-4 card-data">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Add New Kesulitan</h6>
            </div>
            <div class="card-body add-blog px-4 tambah-kesulitan">
                <form action="/kesulitan/save" method="post" enctype="multipart/form-data">
                    <?= csrf_field(); ?>
                    ...
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
                            <span class="input-group-text" id="basic-addon1">ID Kesulitan</span>
                        </div>
                        <input type="text" class="rounded-right form-control<?= ($validation->hasError('id')) ? ' is-invalid' : ''; ?>" placeholder="" aria-label="Username" aria-describedby="basic-addon1" name="id" value="<?= old('id'); ?>">
                        <div class="invalid-feedback">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <select class="rounded-right custom-select <?= ($validation->hasError('kesulitan')) ? ' is-invalid' : ''; ?>" id="inputGroupSelect01" name="kesulitan">
                            <option value="<?= (old('kesulitan')) ? old('kesulitan') : ''; ?>" selected hidden><?= (old('kesulitan')) ? old('kesulitan') : 'Choose...'; ?></option>
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="rounded-right form-control<?= ($validation->hasError('skore')) ? ' is-invalid' : ''; ?>" placeholder="" aria-label="Username" aria-describedby="basic-addon1" name="skore" value="<?= old('skore'); ?>">
                        <div class="invalid-feedback">
